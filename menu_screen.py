...
class Menu :
    ...
    def display_main_menu(options) :
        ...
        for i in range (0,n_rect) :
            ...
            messages.display_message(options[i], v2(GameConfig.Graphics.WindowWidth/2, cote_haut+(intervalle/2)), "PressStart2P", pygame.Color('black'), False)     # On affiche le texte de l'option
