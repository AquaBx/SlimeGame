...
class Menu :
    ...
    def display_main_menu(options) :
        ...
        for i in range (0,n_rect) :
            ...
            messages.display_message(window, options[i], int(GameConfig.WINDOW_SIZE.x/2), cote_haut+int(intervalle/2),"BLOBBYCHUG", 30, pygame.Color('black'), False)     # On affiche le texte de l'option
