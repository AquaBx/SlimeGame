...
class Entity:
    ...
    def implement_player():
        return Entity(10*Config.BLOCK_SIZE,Config.WINDOW_H-2*Config.BLOCK_SIZE,Config.BLOCK_SIZE,Config.BLOCK_SIZE,"Assets/GreenSlime/Grn_Idle1.png")
    ...
    def blit_player(self, window, x_cam, y_cam):
        ncoord = ( self.position.x-x_cam+Config.WINDOW_W/2-self.taille.x/2 , self.position.y-y_cam+Config.WINDOW_H/2)
